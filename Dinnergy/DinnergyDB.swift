...
class DinnergyDB {
    ...
    insertRecipe(name: "Vegetarian Chilli", ingredients: "400g pack oven-roasted vegetables\n\n1 can kidney beans in chilli sauce\n\n1 can chopped tomatoes\n\n1 ready-to-eat mixed rice pouch", method: "1.Heat oven to 200C/180C fan/ gas 6. Cook the vegetables in a casserole dish for 15 mins. Tip in the beans and tomatoes, season, and cook for another 10-15 mins until piping hot. Heat the pouch in the microwave on High for 1 min and serve with the chilli." , attachment: "https://www.bbcgoodfood.com/sites/default/files/styles/recipe/public/recipe/recipe-image/2016/06/veggie-chilli.jpg?itok=qvb6j2i4")
